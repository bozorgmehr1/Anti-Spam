...
https = require "ssl.https"
CerNerCompany = 'بوت آنلاین'
SUDO_ID = {388861945,362270285} --Admins
Full_Sudo = {388861945,362270285} --Sudo --- 
ChannelLogs = 362270285 ---Channel log
BotHelper = 492594458 --ID Bot helper
Channel = '@BotOnline' -- Channel
MsgTime = os.time() - 60
Plan1 = 2592000
Plan2 = 7776000
function UpTime()
